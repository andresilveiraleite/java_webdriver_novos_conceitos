...
## Utilizamo para definirmos o que será executado antes e depois dos nossos testes
### É importante salientar que a cada execução do bloco de teste "@Test" é executado o @before e o @after

Ex. para execução de 2 scrips de testes para visualizarmos a execução independente dos scripts de teste:
É importante salientar que iremos colocar informações incoerentes no 2 script para que falha e tenhamos uma visão clara de 2 execuções.
...
public class InformacoesUsuarioTest {
    ...
    @Test   //É importante salientar que todo "@test" vai sempre chamar o @before e @after
    ...
    public void testAdicionarUmaInformacaoAdicionalDoUsuario2() {
        ...
        //Preencher o campo name "password" que está dentro do formulário de login --> 123456
        formularioSignInbox.findElement(By.name("password")).sendKeys("123456ddd");
